    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"D:\Attendace_management_system-master\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"D:\Attendace_management_system-master\Attendance\-------Check atttendance-------"')
